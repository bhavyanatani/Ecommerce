...
export const Plasma = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      console.error('Error initializing Plasma effect:', e);
      return () => {};
    }
  }, [color, speed, direction, scale, opacity, mouseInteractive]);

  return <div ref={containerRef} className="w-full h-full overflow-hidden relative" style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }} />;
};
