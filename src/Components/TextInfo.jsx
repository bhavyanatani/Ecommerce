  ...
  return (
    ...
    >
      ...
      <motion.h1 
        ...
        className={`text-3xl md:text-4xl font-extrabold ${themeColors[mode].text} mb-2 tracking-tight leading-tight`}
      >
        Classic White Shirt
      </motion.h1>
      ...
      <motion.p 
        ...
        className={`${mode === 'Basic' ? 'text-gray-700 border-gray-200' : 'text-gray-300 border-gray-700'} 
          text-base leading-relaxed mb-4 border-b pb-3 font-light`}
      >
        ...
        <motion.div variants={itemVariants} className="mb-4 flex-1">
          <h2 className={`text-lg font-semibold ${themeColors[mode].text} mb-3 flex items-center`}>
          ...
          <ul className={`grid grid-cols-2 gap-2 ${mode === 'Basic' ? 'text-gray-700' : 'text-gray-300'}`}>
            {[
              ...
              <motion.li 
                key={index}
                className={`flex items-center p-1.5 rounded-lg ${mode === 'Basic' ? 'hover:bg-gray-100' : 'hover:bg-gray-800'} transition-colors duration-200`}
                whileHover={{ x: 5 }}
